...
if(Qt5Core_FOUND)
    ...
    set(QT5 TRUE)
    set(QT4 FALSE)
    set(QT_LIBS ${Qt5Widgets_LIBRARIES} ${Qt5Gui_LIBRARIES} ${Qt5Core_LIBRARIES} )
	...
	set(QT_LIBS ${QT_QTCORE_LIBRARY} ${QT_QTGUI_LIBRARIES})
	set(QT_INCLUDE ${QT_QTCORE_INCLUDE_DIR} ${QT_QTGUI_INCLUDE_DIR})
